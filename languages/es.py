...
'* Discounts only applicable when paid online': '* Discounts only applicable when paid online',
'+ And': '+ And',
'+ Or': '+ Or',
'<': '<',
'<=': '<=',
...
'Adding new brand': 'Adding new brand',
'Adding new measure unit': 'Adding new measure unit',
...
'created on': 'creado en',
'Created on': 'Creado en',
'Creating a new trait': 'Creating a new trait',
...
'New offer group': 'New grupo de ofertas',
...
'Some items in the order are not available, press the purchase order button to create a purchase that contains the order items': 'Algunos items en la order no están disponibles, presione el botono comprar orden para crear una compra con los items faltantes',
...
'This payment requires a 4 digits account': 'This payment requires a 4 digits account',
...
'YES': 'SÍ',
'yes': 'sí',
'You already have a payment with that payment option': 'You already have a payment with that payment option',
