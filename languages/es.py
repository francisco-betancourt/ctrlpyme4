...
'Scan sale tickets to create an invoice': 'Scan sale tickets to create an invoice',
'Scan tickets for invoice': 'Scan tickets for invoice',
'Search': 'Buscar',
...
'Select your current store': 'Selecciones su tienda actual',
'Seller': 'Vendedor',
'Sellers': 'Vendedores',
'Semantic': 'Semántica',
...
'Some items in the order are not available, press the purchase order button to create a purchase that contains the order items': 'Some items in the order are not available, press the purchase order button to create a purchase that contains the order items',
...
'Trait': 'Rasgo',
'Trait Categories': 'Categorías para los Ragos',
