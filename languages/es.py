...
'#': '#',
'$ %s added to wallet.': '$ %s agregados a cartera.',
'$ %s removed from wallet.': '$ %s removidos de cartera.',
...
'Add or remove funds': 'Agregar o remover fondos',
...
'allow_fractions': 'permite_fracciones',
...
'Are you sure you want to discard this inventory?': 'Estas seguro de que quieres descartar este inventario?',
'Are you sure you want to hide the selected elements?': 'Esta seguro que quiere ocultar los elementos seleccionados?',
'Are you sure you want to merge': 'Esta seguro que desea juntar',
'Are you sure you want to merge %s funds to this wallet?': 'Are you sure you want to merge %s funds to this wallet?',
'Are you sure you want to merge %s funds with this wallet': 'Esta seguro de que quiere juntar los fondos de %s con esta cartera',
...
'change': 'cambio',
'Change': 'cambio',
'Change Password': u'Cambie la Contraseña',
'Change password': u'Cambie la contraseña',
'change password': u'cambie la contraseña',
...
'click': 'presione',
'Click on the link %(link)s to reset your password': u'Pulse en el enlace %(link)s para reiniciar su contraseña'.encode('utf8'),
...
'extra_data1': 'datos_extra1',
'extra_data2': 'datos_extra2',
'extra_data3': 'datos_extra3',
'Failed': 'Falla',
...
'funds to this wallet': 'funds to this wallet',
...
'Inventory done, system stock fixed': 'Inventario completo, cantidades en stock corregidas.',
...
'Item preview': 'Vista previa del item',
...
'Items not reported': 'Items no reportados',
...
'items quantity': 'cantidad de items',
...
'load from CSV': 'cargar desde CSV',
...
'Only alphanumeric characters, -, $, ., %, *, /': 'Solo caracteres alfanuéricos o -, $, ., %, *, /',
'Option': 'Opción',
'Options': 'Opciones',
...
'Or select a client to merge its funds to wallet %s': 'O seleccione un cliente para juntar sus fondos con la cartera %s',
'Order': 'Orden',
...
'Processing, this may take some time ...': 'Procesando, esto puede tardar algun tiempo ...',
...
'Sale reward': 'Recompensa de venta',
'sale reward': 'recompensa de venta',
...
'Serial numbers': 'Números seriales',
'Service expiration': 'Expiración de servicio',
'Services': 'Servicios',
...
'Some fields are missing: %s': 'Algunos campos no están presentes: %s',
...
'Some items were not reported in the inventory': 'Algunos items no fueron reportados.',
...
'There are no items to refund': 'No hay items para devolver',
...
'To pay with credit notes, select the wallet payment option': 'Para pagar con notas de crédito, seleccione la forma de pago wallet',
...
'Value already in database or empty': 'El valor ya esta en la base de datos',
